...
export default function Page() {
  const t = useTranslations("pages.products.ai");
  return (
    <>
      ...
      <Section variant="surface">
        <SectionHead eyebrow={t("governance.eyebrow")} title={t("governance.heading")} summary={t("governance.summary")} />
        <p className="max-w-[640px] text-[15px] leading-[1.7] text-muted-foreground">{t("governance.summary")}</p>
      </Section>
