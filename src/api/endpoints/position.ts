...
export const putApiV10PositionId = (
    id: string,
    positionCreate: BodyType<PositionCreate>,
...
export const getPutApiV10PositionIdMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putApiV10PositionId>>, TError,{id: string;data: BodyType<PositionCreate>}, TContext>, request?: SecondParameter<typeof useCustomClient>}
): UseMutationOptions<Awaited<ReturnType<typeof putApiV10PositionId>>, TError,{id: string;data: BodyType<PositionCreate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof putApiV10PositionId>>, {id: string;data: BodyType<PositionCreate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PutApiV10PositionIdMutationBody = BodyType<PositionCreate>
...
export const getPostApiV10PositionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV10Position>>, TError,{data: BodyType<PositionCreate>}, TContext>, request?: SecondParameter<typeof useCustomClient>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV10Position>>, TError,{data: BodyType<PositionCreate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV10Position>>, {data: BodyType<PositionCreate>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV10PositionMutationBody = BodyType<PositionCreate>
