...
export const putApiV10ContactId = (
    id: string,
    contactCreate: BodyType<ContactCreate>,
...
export const getPutApiV10ContactIdMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putApiV10ContactId>>, TError,{id: string;data: BodyType<ContactCreate>}, TContext>, request?: SecondParameter<typeof useCustomClient>}
): UseMutationOptions<Awaited<ReturnType<typeof putApiV10ContactId>>, TError,{id: string;data: BodyType<ContactCreate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof putApiV10ContactId>>, {id: string;data: BodyType<ContactCreate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PutApiV10ContactIdMutationBody = BodyType<ContactCreate>
...
export const usePutApiV10ContactId = <TError = ErrorType<void>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {id: string;data: BodyType<ContactCreate>},
        TContext
      > => {
...
export const getPostApiV10ContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV10Contact>>, TError,{data: BodyType<ContactCreate>}, TContext>, request?: SecondParameter<typeof useCustomClient>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV10Contact>>, TError,{data: BodyType<ContactCreate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV10Contact>>, {data: BodyType<ContactCreate>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV10ContactMutationBody = BodyType<ContactCreate>
